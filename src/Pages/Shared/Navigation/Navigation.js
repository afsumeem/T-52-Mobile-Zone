...
const Navigation = () => {
    ...
    return (
        <div>
            ...
            {/* main navbar */}
            <Navbar collapseOnSelect expand="lg" style={{ background: "#fef5ef", padding: "20px 0", boxShadow: '0 10px 40px 0px rgb(0 0 0 / 15%)' }}>
                <Container>
                        ...
                        <Nav>
                            ...
                            <div id="user_box">
                                <NavDropdown title={userIcon} id="collasible-nav-dropdown">
                                    ...
                                    <NavDropdown.Item>
                                        {user.email ? (<Button onClick={logOut} className="btn_regular">Log Out</Button>) : (
                                            <Link to="/login">
