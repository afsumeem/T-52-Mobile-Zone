    ...
    return (
        <div>
            ...
            <Navbar collapseOnSelect expand="lg" style={{ background: '#ebebeb' }}>
                <Container>
                    <Navbar.Brand className="fw-bold" href="#home"><span style={{ color: 'red' }}>T-52</span> Mobile Zone</Navbar.Brand>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="mx-auto">
                            <Form className="d-flex">
                                ...
                                />
                                <Button className="search_btn" style={{ borderRadius: '0 30px 30px 0' }} variant="outline-success">Search</Button>
                            </Form>
                        </Nav>
                        <Nav>
            ...
            <Navbar collapseOnSelect expand="lg" style={{ background: '#fef5ef', padding: '20px 0' }}>
                <Container>
                    <NavDropdown title="All-Brands" id="collasible-nav-dropdown">
                        ...
                        <NavDropdown.Item as={Link} to="/huawei">Huawei</NavDropdown.Item>
                        <NavDropdown.Item as={Link} to="/oppo">Oppo</NavDropdown.Item>
                        <NavDropdown.Item as={Link} to="/vivo">Vivo</NavDropdown.Item>
                        <NavDropdown.Item as={Link} to="/xiaomi">Xiaomi</NavDropdown.Item>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav>
                            <Nav.Link className="nav_icon" href="#deets">{hardIcon}<Badge>0</Badge></Nav.Link>
                            <Nav.Link className="nav_icon" href="#deets">{shoppingCart}<Badge>0</Badge></Nav.Link>
